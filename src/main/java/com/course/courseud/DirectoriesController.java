...
public class DirectoriesController {
    ...
    @FXML
    private TableView<ObservableList<String>> directoriesTable;
    ...
    private void fillUpdatesTextField() {
        StringBuilder stringBuilder = new StringBuilder(directoriesTable.getSelectionModel().getSelectedItem().toString());
    ...
    private void fillOrderByComboBox() {
        ...
        for (TableColumn<ObservableList<String>, ?> tc : directoriesTable.getColumns()) {
    ...
    private void deleteRow() {
        ...
        Label userLabel = new Label("Вы уверены, что хотите удалить запись "
                + directoriesTable.getSelectionModel().getSelectedItem() + "?");
        ...
        if (option.get() == enterYes) {
            String sqlQuery = "DELETE FROM " + tablesComboBox.getValue() + " WHERE " +
                    directoriesTable.getColumns().get(0).getText() + " = "
                    + directoriesTable.getSelectionModel().getSelectedItem().get(0);
    ...
    private void updateRow() {
        ...
        for (int i = 0; i < directoriesTable.getColumns().size(); i++) {
            stringBuilderValues
                    .append(directoriesTable.getColumns().get(i).getText())
                    .append(" = ")
                    .append(oldValues[i])
                    .append(", ");
        }
        ...
        stringBuilderValues
                ...
                .append(" WHERE ")
                .append(directoriesTable.getColumns().get(0).getText())
                .append(" = ")
                .append(directoriesTable.getSelectionModel().getSelectedItem().get(0))
                .append(";");
    ...
    private void makeTableView() {
        directoriesTable.getColumns().clear();
        String sqlQuery = "SELECT * FROM " + tablesComboBox.getValue();
        sqlQuery = utilsController.appendWhereAndOrderByToQuery(whereTextField, orderByComboBox, ascCheckBox, sqlQuery);
        utilsController.fillTableWithSqlQuery(directoriesTable, sqlQuery);
    }
