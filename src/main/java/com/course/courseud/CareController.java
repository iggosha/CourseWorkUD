...
public class CareController {
    ...
    @FXML
    private TableView<ObservableList<String>> careTable;
    ...
    private void fillUpdatesTextField() {
        StringBuilder stringBuilder = new StringBuilder(careTable.getSelectionModel().getSelectedItem().toString());
    ...
    private void fillOrderByComboBox() {
        ...
        for (TableColumn<ObservableList<String>, ?> tc : careTable.getColumns()) {
    ...
    private void deleteRow() {
        ...
        Label userLabel = new Label("Вы уверены, что хотите удалить запись "
                + careTable.getSelectionModel().getSelectedItem() + "?");
        ...
        if (option.get() == enterYes) {
            String sqlQuery = "DELETE FROM " + nameLabel.getText() + " WHERE " +
                    careTable.getColumns().get(0).getText() + " = "
                    + careTable.getSelectionModel().getSelectedItem().get(0);
    ...
    private void updateRow() {
        ...
        for (int i = 0; i < careTable.getColumns().size(); i++) {
            stringBuilderValues
                    .append(careTable.getColumns().get(i).getText())
                    .append(" = ")
                    .append(oldValues[i])
                    .append(", ");
        }
        ...
        stringBuilderValues
                ...
                .append(" WHERE ")
                .append(careTable.getColumns().get(0).getText())
                .append(" = ")
                .append(careTable.getSelectionModel().getSelectedItem().get(0))
                .append(";");
    ...
    private void makeTableView() {
        careTable.getColumns().clear();
        String sqlQuery = "SELECT * FROM " + nameLabel.getText();
        sqlQuery = utilsController.appendWhereAndOrderByToQuery(whereTextField, orderByComboBox, ascCheckBox, sqlQuery);
        utilsController.fillTableWithSqlQuery(careTable, sqlQuery);
    }
